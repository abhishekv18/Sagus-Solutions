...
//           : 'bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-blue-900/90 backdrop-blur-lg py-4'
//       }`}
//     >
...
//                 <div className="absolute -inset-3 bg-gradient-to-r from-teal-500/30 to-green-500/30 rounded-xl opacity-0 group-hover:opacity-100 blur-md transition-all duration-500"></div>
                
//                 {/* Logo with tech-inspired border */}
//                 <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-2.5 rounded-xl border border-slate-700/50 group-hover:border-teal-500/30 transition-all duration-500 overflow-hidden">
//                   {/* Subtle grid pattern */}
...
//                     src="/sagus[1].png" 
//                     alt="SAGUS SOLUTIONS" 
//                     className="h-8 w-auto transition-all duration-500 group-hover:scale-110 group-hover:rotate-2 filter brightness-110 contrast-110"
//                   />
//                 </div>
//               </div>
//             </div>
...
//               <span className="text-slate-50 font-bold text-xl tracking-tight bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent group-hover:from-teal-300 group-hover:to-green-300 transition-all duration-500">
//                 SAGUS
//                 <span className="text-teal-400">.</span>
//               </span>
//               <span className="text-slate-400 font-medium text-xs tracking-wider uppercase mt-0.5 group-hover:text-slate-300 transition-colors duration-300">
//                 DIGITAL SOLUTIONS
//               </span>
              
//               {/* Animated tech underline */}
//               <div className="absolute -bottom-1.5 left-0 w-0 h-0.5 bg-gradient-to-r from-teal-400 to-green-400 group-hover:w-full transition-all duration-700"></div>
//             </div>
...
//                 key={item.path}
//                 to={item.path} 
//                 className={`relative flex items-center px-5 py-3 rounded-xl text-sm font-medium transition-all duration-300 group ${
//                   isActive(item.path) 
//                     ? 'text-teal-400' 
...
//                   {item.icon}
//                 </div>
//                 <span className="ml-2.5 font-semibold tracking-wide">{item.label}</span>
...
//             <Link 
//               to="/contact" 
//               className="relative flex items-center px-6 py-3 bg-gradient-to-r from-teal-500 to-green-500 hover:from-teal-400 hover:to-green-400 text-white text-sm font-semibold rounded-xl transition-all duration-300 group shadow-lg shadow-teal-500/30 hover:shadow-teal-500/40 overflow-hidden"
...
//           <button
//             onClick={toggleMenu}
//             className="lg:hidden p-3 rounded-xl text-slate-300 hover:text-slate-50 hover:bg-slate-800/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-teal-500/30"
//             aria-label="Toggle menu"
//           >
//             <div className="relative w-6 h-6">
//               <span className={`absolute block w-5 h-0.5 bg-current transform transition duration-300 ease-in-out ${
//                 isOpen ? 'rotate-45 translate-y-0' : '-translate-y-1.5'
//               }`}></span>
//               <span className={`absolute block w-5 h-0.5 bg-current transition duration-300 ease-in-out ${
...
//         }`}>
//           <div className="py-4 border-t border-slate-700/30">
//             <nav className="space-y-2">
//               {navItems.map((item) => (
//                 <Link 
//                   key={item.path}
//                   to={item.path} 
//                   className={`flex items-center px-5 py-4 rounded-xl text-base font-medium transition-all duration-300 group ${
//                     isActive(item.path) 
...
//                 <Link 
//                   to="/contact" 
//                   className="flex items-center justify-center w-full px-5 py-4 bg-gradient-to-r from-teal-500 to-green-500 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg shadow-teal-500/30 hover:shadow-teal-500/40"
//                   onClick={closeMenu}
//                 >
