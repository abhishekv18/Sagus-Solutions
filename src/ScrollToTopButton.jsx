...
const ScrollToTopButton = () => {
  ...
  return (
    ...
    <button
     ...
     className={`fixed block sm:bottom-7 sm:right-1 z-50 group p-2 bg-gradient-to-t from-white via-green-400 to-green-500 hover:bg-green-600 text-white rounded-full shadow-xl 
